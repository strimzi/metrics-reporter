...
public class KafkaMetricWrapperTest {
    ...
    public void testKafkaMetricName() {
        String metricName = KafkaMetricWrapper.prometheusName("kafka_server", new MetricName("NaMe", "KafKa.neTwork", "", Map.of()));
    ...
    public void testKafkaMetric() {
        ...
        KafkaMetric metric = newKafkaMetric("name", "group", (config, now) -> value.get(), Map.of());
